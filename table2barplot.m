function [datamatrix,p]=table2barplot(variable,mousecategories_in_table)
...
cats=unique(mousecategories_in_table);

JustLRRKix=mousecategories_in_table==cats(1);
JustWTix=mousecategories_in_table==cats(2);
...
somenames={char(cats(1)) char(cats(2))};
set(gca,'XTickLabel',somenames')

[h,p]=ttest(datamatrix(:,1),datamatrix(:,2));
disp(p)
